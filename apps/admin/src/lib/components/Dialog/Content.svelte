...
<div use:melt={$portalled}>
  {#if $open}
    ...
    />
    <div
      class="fixed inset-0 flex w-full min-w-full shrink-0 items-center justify-center overflow-x-hidden overflow-y-auto p-2 md:p-6"
    >
      <div
        bind:this={ref}
        use:melt={$content}
        class={cn(
          ...
          size === 'md' &&
            'w-full p-5 lg:max-w-[800px] lg:min-w-[720px] lg:p-9',
