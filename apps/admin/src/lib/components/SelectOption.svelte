...
<Select.Item
  {label}
  {value}
  class="group/option grid w-[var(--bits-select-anchor-width)] cursor-default grid-cols-[--spacing(5)_1fr] items-baseline gap-x-2 rounded-lg py-2.5 pr-3.5 pl-2 text-base/6 text-zinc-950
