...
<button
  ...
  class={cn(
    ...
    !plain &&
      'bg-zinc-950/90 text-white before:absolute before:inset-0 before:-z-10 before:rounded-lg before:bg-zinc-900 before:shadow-sm after:absolute after:inset-0 after:-z-10 after:rounded-lg hover:after:bg-white/10 *:[svg]:text-zinc-400 hover:*:[svg]:text-zinc-300',
    plain &&
