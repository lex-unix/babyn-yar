...
<div class="fixed right-0 bottom-0 z-1000 m-4 flex flex-col items-end gap-2" use:portal>
	{#each $toasts as { id, data } (id)}
		...
		>
			<div class="relative w-[24rem] max-w-[calc(100vw-2rem)] px-4 py-5 text-sm/5 text-gray-50">
